...
<div
	class={`drawer-mobile drawer ${isCollapsed ? 'w-20' : 'w-32'} max-h-screen fixed bg-[#f5fffe] z-[1] md:pt-36 flex flex-col text-[#0D494E] shadow-lg transition-all duration-300`}
>
